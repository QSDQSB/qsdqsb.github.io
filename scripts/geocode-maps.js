 ...
 *
 * Builds the voyage atlas (global + per-parent) directly from _voyage /
 * _subvoyage frontmatter, geocoding missing coordinates and writing derived
 * GeoJSON cache files to assets/maps/.
 *

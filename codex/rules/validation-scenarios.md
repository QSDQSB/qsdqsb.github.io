...
- Any of:
  - `map_dataset: <name>` referenced, missing `assets/maps/<name>.geojson` after preprocess (explicit override — must resolve to the global atlas or a per-parent atlas, no other source exists).

...
A heavily customised Jekyll site (forked from Minimal Mistakes / Academic Pages) serving as QSD's personal blog, travel gallery, and portfolio. Hosted on **Cloudflare Pages** at `qsdqsb.com`; GitHub Pages is intentionally disabled — do not re-enable it.
